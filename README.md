...
| **Оставшееся время** | Оставшееся время до завершения программы | `sensor.skycoocker_remaining_time` | минут | 0, 15, 30, 60 |
| **Общее время** | Общее время выбранной программы | `sensor.skycoocker_total_time` | минут | 30, 60, 90 |
| **Время автоподогрева** | Время работы в режиме автоподогрева | `sensor.skycoocker_auto_warm_time` | минут | 0, 30, 60 |
| **Процент успеха** | Процент успешных команд (показатель стабильности соединения) | `sensor.skycoocker_success_rate` | % | 0-100 |
| **Время до отложенного запуска** | Время до начала отложенного запуска | `sensor.skycoocker_delayed_launch_time` | минут | 0, 30, 60 |
