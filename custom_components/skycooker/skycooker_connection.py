...
class SkyCookerConnection(SkyCooker):
    ...
    def sound_enabled(self):
        return self.state_manager.sound_enabled

    @property
    def error_code(self):
        return self.state_manager.error_code

    @property
    def is_cooking(self):
        """True, если устройство готовит или разогревает."""
        return self.state_manager.is_cooking

    @property
    def is_warming(self):
        """True, если устройство в режиме разогрева."""
        return self.state_manager.is_warming

    @property
    def is_auto_warm_active(self):
        """True, если активен режим автоподогрева."""
        return self.state_manager.is_auto_warm_active

    @property
    def is_delayed_start_active(self):
        """True, если активен отложенный старт."""
        return self.state_manager.is_delayed_start_active
